const MODULOS = [
  ...
  {
    id: 'mod-2', titulo: 'Variáveis e tipos', descricao: 'Como armazenar dados em diferentes linguagens.',
  ...
  {
    id: 'mod-3', titulo: 'Condicionais', descricao: 'Tomada de decisão com SE/ENTÃO e equivalentes.',
  ...
  {
    id: 'mod-4', titulo: 'Laços de repetição', descricao: 'Repita comandos com PARA/ENQUANTO em múltiplas linguagens.',
  ...
  {
    id: 'mod-5', titulo: 'Funções e reutilização', descricao: 'Criando blocos reutilizáveis em diferentes sintaxes.',
